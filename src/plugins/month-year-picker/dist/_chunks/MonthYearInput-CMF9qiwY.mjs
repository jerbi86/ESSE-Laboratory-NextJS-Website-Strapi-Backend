...
import { Field, Box, Flex, Radio, SingleSelect, SingleSelectOption, DatePicker } from "@strapi/design-system";
...
const MonthYearInput = forwardRef((props, ref) => {
  ...
  const [mode, setMode] = useState(rangeActive ? "range" : "single");
  const [precision, setPrecision] = useState(initialPrecision);
  const s = parseParts(initialSingleSource);
  const [y, setY] = useState(Number.isNaN(s.y) ? "" : s.y);
  const [m, setM] = useState(Number.isNaN(s.m) ? "" : s.m);
  const [d, setD] = useState(Number.isNaN(s.d) ? "" : s.d);
  const l = parseParts(rangeActive ? left : "");
  const r = parseParts(rangeActive ? right : "");
  const [sy, setSY] = useState(Number.isNaN(l.y) ? "" : l.y);
  const [sm, setSM] = useState(Number.isNaN(l.m) ? "" : l.m);
  const [sd, setSD] = useState(Number.isNaN(l.d) ? "" : l.d);
  const [ey, setEY] = useState(Number.isNaN(r.y) ? "" : r.y);
  const [em, setEM] = useState(Number.isNaN(r.m) ? "" : r.m);
  const [ed, setED] = useState(Number.isNaN(r.d) ? "" : r.d);
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsx(Field.Root, { name, id: name, error, required: isRequired, hint: opt.hint, children: /* @__PURE__ */ jsx(Box, { ref, children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "stretch", gap: 3, children: [
    /* @__PURE__ */ jsxs(Field.Label, { children: [
      name,
      isRequired ? " *" : ""
    ] }),
    allowRange && /* @__PURE__ */ jsx(
      Radio.Group,
      {
        name: `${name}-mode`,
        value: mode,
        ...
        "aria-label": "Mode",
        children: /* @__PURE__ */ jsxs(Flex, { gap: 4, wrap: "wrap", children: [
          /* @__PURE__ */ jsx(Radio.Item, { value: "single", children: "Single" }),
          /* @__PURE__ */ jsx(Radio.Item, { value: "range", children: "Range" })
        ] })
      }
    ),
    /* @__PURE__ */ jsx(
      Radio.Group,
      {
        ...
        children: /* @__PURE__ */ jsxs(Flex, { gap: 4, wrap: "wrap", children: [
          allowedPrecisions.includes("year") && /* @__PURE__ */ jsx(Radio.Item, { value: "year", children: "Year" }),
          allowedPrecisions.includes("month") && /* @__PURE__ */ jsx(Radio.Item, { value: "month", children: "Month & Year" }),
          allowedPrecisions.includes("date") && /* @__PURE__ */ jsx(Radio.Item, { value: "date", children: "Full date" })
        ] })
      }
    ),
    mode === "single" && /* @__PURE__ */ jsxs(Fragment, { children: [
      precision === "year" && /* @__PURE__ */ jsx(
        SingleSelect,
        {
          id: `${name}-year`,
          label: "Year",
          ...
          children: years.map((yy) => /* @__PURE__ */ jsx(SingleSelectOption, { value: String(yy), children: yy }, yy))
        }
      ),
      precision === "month" && /* @__PURE__ */ jsxs(Flex, { gap: 2, wrap: "wrap", children: [
        /* @__PURE__ */ jsx(
          SingleSelect,
          {
            id: `${name}-month`,
            ...
            children: months.map((mm) => /* @__PURE__ */ jsx(SingleSelectOption, { value: String(mm), children: pad2(mm) }, mm))
          }
        ),
        /* @__PURE__ */ jsx(
          SingleSelect,
    ...
    mode === "range" && /* @__PURE__ */ jsxs(Fragment, { children: [
      precision === "year" && /* @__PURE__ */ jsxs(Flex, { gap: 2, wrap: "wrap", children: [
        /* @__PURE__ */ jsx(
          SingleSelect,
          {
            id: `${name}-start-year`,
      ...
      precision === "month" && /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 2, children: [
      ...
      precision === "date" && /* @__PURE__ */ jsxs(Flex, { gap: 2, wrap: "wrap", children: [
        /* @__PURE__ */ jsx(
          DatePicker,
          {
            id: `${name}-start-date`,
